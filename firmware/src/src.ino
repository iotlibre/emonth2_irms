...
//const unsigned long WDT_MAX_NUMBER = 190;
...
// +++ analog measurement:                                        // INT 1 / Dig 3 Screw Terminal Block Number 4
#define OFFSET       17
// const byte ANALOG_POWER=   6;
const byte ANALOG_POWER=   5;
const byte ANALOG_INPUT=   16;
...
*/
    ...
    if (analog_measure==1){
      ...
      emon1.current(ANALOG_INPUT,20.0);
      delay(5);
      int analog_value=int(analogRead(OFFSET));
      ...
      emonth.temp_external = (int)(power*10);
      if (debug==1){
